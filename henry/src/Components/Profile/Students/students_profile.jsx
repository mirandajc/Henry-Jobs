...
export default function StudentsProfile({ id, userTypes, backFront, banner, country, curriculumCounter, stars, email, lastName, name, profileImage, followers, following }) {
